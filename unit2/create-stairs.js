...
function createStairs() {
	...
	var verticalY = verticalStepHeight/2;
	var verticalZ = 0;

	var horizontalY = stepThickness/2 + verticalStepHeight;
	var horizontalZ = horizontalStepDepth/2 - stepHalfThickness;
	...
	for (var i = 0; i < numberOfSteps; i++) {
		...
		stepMesh.position.y = verticalY;	// half of height: put it above ground plane
		stepMesh.position.z = verticalZ;	// centered at origin
		scene.add( stepMesh );
		...
		stepMesh.position.y = horizontalY;
		// Push step forward by half the depth, minus half the vertical step's thickness
		stepMesh.position.z = horizontalZ;
		scene.add( stepMesh );

		verticalY += verticalStepHeight + stepThickness;
		verticalZ += horizontalStepDepth - stepThickness;

		horizontalY += verticalStepHeight + stepThickness;
		horizontalZ += horizontalStepDepth - stepThickness;
	}
}
